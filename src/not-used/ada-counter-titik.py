...
def iterations(points, next_points, graph_points, iteration, i_now, save_graphs, point_count):
    ...
    if iteration == 0:
        ...
        save_graphs.append(graph_points)
        point_count.append(len(graph_points))  # Update jumlah titik pada setiap iterasi
        return iterations(points, new_next_points, graph_points, iteration-1, i_now+1, save_graphs, point_count)
        ...
        return iterations(points, each_next, graph_points, iteration-1, i_now+1, save_graphs, point_count)
...
previous_curves = []
saved_graphs = []
point_count = [len(graph_points)]  # Menyimpan jumlah titik pada setiap iterasi

# Mengambil titik-titik untuk membentuk kurva bezier
saved_graphs = iterations(points, next_points, graph_points, i, 0, saved_graphs, point_count)
...
# Cetak jumlah titik pada setiap iterasi
print("Jumlah titik pada setiap iterasi:")
for idx, count in enumerate(point_count):
    print(f"Iterasi {idx}: {count}")
